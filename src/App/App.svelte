<script>
    ...
    let gameWorksheet = isValid ? worksheet : getNewGameInfo();
    ...
    function doInitialGameWorksheetLoad() {
        ...
        try {
            worksheet = (url.searchParams.has('gameWorksheet'))
                    ...
                    : localStorageController.loadGameWorksheet();
    ...
    function validateGameWorksheet(worksheet) {
        ...
        try {
            ...
            _ = worksheet.stuntsAndExtras.toString();
            _ = worksheet.dials.numberOfAspects.toString();
            _ = worksheet.dials.numberOfColumns.toString();
            _ = worksheet.dials.numberOfInitialStunts.toString();
            _ = worksheet.dials.numberOfPhases.toString();
            _ = worksheet.dials.refreshRate.toString();
            _ = worksheet.dials.skillCap.toString();
            _ = worksheet.dials.typesOfStressTracks.toString();
            _ = worksheet.dials.initialSkillsDistribution.toString();
            _ = worksheet.dials.defaultNumberOfStressBoxes.toString();
            _ = worksheet.dials.defaultConsequenceSlots.toString();
            _ = worksheet.facesAndPlaces[0].name.toString();
            _ = worksheet.facesAndPlaces[0].issuesOrAspects.toString();
            _ = worksheet.skills[0].toString();
